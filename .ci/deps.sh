...
command -v build/bin/quai-devp2p >/dev/null 2>&1 && echo "OK: quai-devp2p command in PATH" || { echo "Please install quai-devp2p"; exit 1; }
command -v build/bin/quaikey-util >/dev/null 2>&1 && echo "OK: quaikey-util command in PATH" || { echo "Please install quaikey-util"; exit 1; }
